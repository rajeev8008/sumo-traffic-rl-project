                    ...
                    try:
                        ...
                        for veh_id in departed:
                            ...
                            try:
                                ...
                                source = 'traci'
                                # Normalize ambulance/fire_truck to "emergency"
                            ...
                            if type_id is None:
                                try:
                                    base = veh_id.split('.')[0]
                                    if "ambulance" in base or "fire_truck" in base or "emergency" in base:
                                        type_id = "emergency"
                                        source = 'inferred'
                                    elif "bus" in base:
                                        type_id = "bus"
...
print(f"\n{'='*130}")
print("BASELINE EVALUATION RESULTS (Fixed-Time Signal)")
print(f"{'='*130}")
...
print(f"\n{'='*130}")
print("PPO AGENT EVALUATION RESULTS (Learned Control)")
print(f"{'='*130}")
print(f"{'Episode':<10} {'Cars Fin.':<12} {'Avg Car (s)':<15} {'Buses Fin.':<12} {'Avg Bus (s)':<15} {'Emerg Fin.':<12} {'Avg Emerg (s)':<15}")
print("-"*130)
